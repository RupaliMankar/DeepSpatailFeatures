...
def unet(pretrained_weights = None, bands=1, imsize=64):
    ...
    up6 = layers.Conv2D(32, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(layers.UpSampling2D(size = (2,2))(drop5))
